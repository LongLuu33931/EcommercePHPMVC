...
<body>
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        <li class="sidebar-item">
                            <a href="<?= _WEB_ROOT . '/permission/index' ?>" class='sidebar-link'>
                                <span>Quản Lý Phân Quyền</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a href="<?= _WEB_ROOT . '/permission/roleList' ?>" class='sidebar-link'>
                                <span>Quản Lý Vai Trò</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a href="<?= _WEB_ROOT . '/permission/productlist' ?>" class='sidebar-link'>
                                <span>Quản Lý Sản Phẩm</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a href="<?= _WEB_ROOT . '/permission/seller' ?>" class='sidebar-link'>
                                <span>Danh Sách Nhà Bán Hàng</span>
                            </a>
                        </li>
                    </ul>
                </div>
    ...
    <script src="<?php echo _WEB_ROOT ?>/public/assets/client/js/feather-icons/feather.min.js"></script>
    <script src="<?php echo _WEB_ROOT ?>/public/assets/client/vendors/perfect-scrollbar/perfect-scrollbar.min.js"></script>
    <script src="<?php echo _WEB_ROOT ?>/public/assets/client/js/app.js"></script>

    <script src="<?php echo _WEB_ROOT ?>/public/assets/client/vendors/simple-datatables/simple-datatables.js"></script>
    <script src="<?php echo _WEB_ROOT ?>/public/assets/client/js/vendors.js"></script>
